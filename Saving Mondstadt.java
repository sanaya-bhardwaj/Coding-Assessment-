...
//There are some n number of piles of mora/coins, where the number of mora/coins in each pile can be given by the array a1,a2,...an Starting with Jean, each player takes turns to take some action on a single selected pile of the player's choice. The actions are of two sorts:
...
//Input
//First line contains a single integer T (1≤T≤1e5) , then the description of T games follow:
