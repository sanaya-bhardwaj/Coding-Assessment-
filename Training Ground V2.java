Hiko Seijuurou is looking for a suitable training ground for his students. He has a found a suitably perilous terrain of M×N
 cells. aij
 is the altitude of the cell on the i
-th row and the j
-th column.

Seijuurou plans to drop students at any of the cells and ask them to visit at least K
 other cells. A student with capability c
 can only move to an adjacent cell (up/down/right/left) if the absolute difference in altitude between the two cells is at most c
.

For each cell, find the minimum capability a student needs to have to visit at least K
 other cells if they start at this cell.
...
M
 lines follow with N
 integers on each line. The j
-th integer on the (i+1)
-th line is aij
.Three integers M,N,K
 on the first line.
...
M
 ...
 integers on each line. The j
-th integer on the i
-th line should be the minimum capability a student needs to have to visit at least K
 other cells if they start at cell (i,j)
.
...
From (1,1)
, if you have 5
 capability, you can reach cell (2,1)
.
From (1,2)
, if you have 6
 capability, you can reach cell (1,1)
.
From (2,1)
, if you have 5
 capability, you can reach cell (1,1)
